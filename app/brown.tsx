...
const BrownPage = () => {
  ...
  const loadData = useCallback(async () => {
    try {
      setLoading(true);
      const response = await fetchData('/?process=AA+Lot+West+1');
      if (response) {
  ...
  return (
    <ImageBackground 
      source={require('../assets/images/brownhall.jpg')} 
    ...
    >
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>AA Lot West</Text>
        </View>
          ...
          <View style={styles.mainContainer}>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.imageContainer}>
                <Image 
                  source={require('../assets/images/brown.jpg')} 
